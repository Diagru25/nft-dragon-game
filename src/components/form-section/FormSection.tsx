...
export default function FormSection() {
  ...
  return (
    <Fragment>
      <div className="mt-52">
        <div className="mt-10">
          <div className="m-auto p-10 max-w-3xl w-full bg-white rounded-2xl">
            <div className="border-b border-solid flex gap-5 w-full mb-2">
              <div
                className={` ${
      ...
      <hr className="w-[50%] max-w-3xl m-auto my-10"/>
    </Fragment>
  );
}
...
const FormTwo = () => {
  const form = useFormik({
    ...
    validationSchema: Yup.object().shape({
      nftNumber: Yup.string().required("Value is not Empty"),
    ...
    <div className="p-6">
      ...
      <div className="mt-4">
        ...
        {form.errors.nftNumber && (
          <span className="text-red-500 text-xs">{form.errors.nftNumber}</span>
        )}
      </div>

      <button
        className="mt-5 rounded-md text-white bg-sky-600 border px-4 py-2 hover:bg-sky-500"
